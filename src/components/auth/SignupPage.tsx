          ...
          <div className="hidden lg:block space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 mb-1">Comprehensive Analytics</h3>
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-pink-100 rounded-xl flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex items-start space-x-3">
                  <input
                    ...
                    id="terms"
                    required
                    className="w-4 h-4 mt-1 text-blue-600 border-slate-300 rounded focus:ring-blue-500 focus:ring-2"
                    disabled={loading}
                  />
